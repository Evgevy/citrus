...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   headMobile: function() { return /* binding */ headMobile; }
/* harmony export */ });
var headMobile = function headMobile() {
  function isMobile() {
    return window.innerWidth <= 1150;
  }
  document.querySelectorAll('.header__item > .header__link').forEach(function (link) {
    link.addEventListener('click', function (e) {
      if (!isMobile()) {
        return;
      }
      var headerItem = this.parentElement;
      var subList = headerItem.querySelector('.header__sub-list');
      if (!subList) {
        return;
      }
      e.preventDefault();
...
/***/ "./js/modules/init-classes-without-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/init-classes-without-slider.js ***!
  \***************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initClassesWithoutSlider: function() { return /* binding */ initClassesWithoutSlider; }
/* harmony export */ });
var initClassesWithoutSlider = function initClassesWithoutSlider() {
  // const greenSlide = document.querySelector('.slide-green');
  // const whiteSlide = document.querySelector('.slide-white');

  // if (!greenSlide || !whiteSlide) return;

  // if (greenSlide.classList.contains('active')) {
  //   whiteSlide.classList.add('rotate-tilt');
  // } else {
  //   whiteSlide.classList.remove('rotate-tilt');
  // }
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkGradeSlider: function() { return /* binding */ checkGradeSlider; },
/* harmony export */   destroyGradeSlider: function() { return /* binding */ destroyGradeSlider; },
/* harmony export */   initGradeSlider: function() { return /* binding */ initGradeSlider; }
/* harmony export */ });
var caroSlider1 = null;
var caroAutoplay1 = null;
var BREAKPOINT = 1120;
var TIMER = 4000;
var initGradeSlider = function initGradeSlider() {
  // Если слайдер уже существует или экран слишком большой - выходим
  if (caroSlider1 || window.innerWidth >= BREAKPOINT) return;
  var sliderContainer1 = document.querySelector('.card__slider');
  ...
  // Автопрокрутка
  caroAutoplay1 = setInterval(function () {
    return caroSlider1.next();
  }, TIMER);

  // Обработчики событий
  var hammer = new Hammer(sliderContainer1);
  var stopAutoplay = function stopAutoplay() {
    clearInterval(caroAutoplay1);
  };
  var restartAutoplay = function restartAutoplay() {
    stopAutoplay();
    caroAutoplay1 = setInterval(function () {
      return caroSlider1.next();
    }, TIMER);
  };
  sliderContainer1.addEventListener('click', stopAutoplay);
  hammer.on('tap', stopAutoplay);
  hammer.on('swipe', restartAutoplay);
};
var destroyGradeSlider = function destroyGradeSlider() {
...
var checkGradeSlider = function checkGradeSlider() {
...
/***/ "./js/modules/init-hack-slider.js":
/*!****************************************!*\
  !*** ./js/modules/init-hack-slider.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initHackSlider: function() { return /* binding */ initHackSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="hack"]');
var initHackSlider = function initHackSlider() {
  if (!slider) {
    return;
  }
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="tape"]');
...
var initIntroSlider = function initIntroSlider() {
  var CaroS = document.querySelector(".Carousel-slider");
  if (!CaroS) return;
  var CaroSlider = new MicroSlider(CaroS, {
    indicators: true,
    indicatorText: ''
  });
  var hammer = new Hammer(CaroS);
  var CaroSTimer = 4000;
  var CaroAutoplay = setInterval(function () {
    return CaroSlider.next();
  }, CaroSTimer);
  CaroS.onclick = function () {
  ...
  hammer.on('swipe', function () {
    clearInterval(CaroAutoplay);
    CaroAutoplay = setInterval(function () {
      return CaroSlider.next();
    }, CaroSTimer);
...
var initMarquee = function initMarquee() {
  var marqueeContent = document.querySelector('.tape__conw-content');
  if (!marqueeContent) return;
  var originalContent = marqueeContent.innerHTML;
  marqueeContent.innerHTML = originalContent + originalContent;
  var contentWidth = marqueeContent.scrollWidth / 2;
  marqueeContent.style.animation = "marquee ".concat(contentWidth / 100, "s linear infinite");
...
var initMove = function initMove() {
  ...
  var nextElement = document.querySelector('.header__next');
  ...
  function handleResponsiveLayout() {
    ...
    // Для экранов 620px-1149px
      ...
      if (nextElement && nextElement.classList.contains('moved-to-menu')) {
        ...
        (_document$querySelect = document.querySelector('.header__actions')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.appendChild(nextElement);
    ...
    // Для экранов 1150px и больше
      ...
      if (button.classList.contains('moved-to-menu')) {
        ...
        (_document$querySelect2 = document.querySelector('.header__actions')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.appendChild(button);
        button.classList.remove('moved-to-menu');
        button.style.display = 'none';
      }
      if (nextElement && nextElement.classList.contains('moved-to-menu')) {
        var _document$querySelect3;
        (_document$querySelect3 = document.querySelector('.header__actions')) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.appendChild(nextElement);
        nextElement.classList.remove('moved-to-menu');
      }
    }
  }
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="tools"]');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   revPopup: function() { return /* binding */ revPopup; }
/* harmony export */ });
var revPopup = function revPopup() {
  var popupOverlay = document.querySelector('.popup-overlay');
  var popupCloseBtn = popupOverlay.querySelector('.popup-close');
  var popupText = popupOverlay.querySelector('.popup-text');
  var popupName = popupOverlay.querySelector('.popup-name');
  var popupPosition = popupOverlay.querySelector('.popup-position');
  var popupAvatar = popupOverlay.querySelector('.popup-avatar');
  ...
  slides.forEach(function (slide) {
    slide.addEventListener('click', function () {
      var name = slide.querySelector('.reviews__name').textContent.trim();
      var position = slide.querySelector('span').textContent.trim();
      var avatarSrc = slide.querySelector('.reviews__image img').src;
      var text = slide.querySelector('.reviews__text').textContent.trim();
      openPopup({
        name: name,
        position: position,
        avatarSrc: avatarSrc,
...
/* harmony import */ var _modules_init_intro_slider__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/init-intro-slider */ "./js/modules/init-intro-slider.js");
/* harmony import */ var _modules_init_hack_slider__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/init-hack-slider */ "./js/modules/init-hack-slider.js");
/* harmony import */ var _modules_rev_popup__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/rev-popup */ "./js/modules/rev-popup.js");
/* harmony import */ var _modules_header_scroll__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/header-scroll */ "./js/modules/header-scroll.js");
/* harmony import */ var _modules_head_mobile__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./modules/head-mobile */ "./js/modules/head-mobile.js");
/* harmony import */ var _modules_init_classes_without_slider__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./modules/init-classes-without-slider */ "./js/modules/init-classes-without-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_header_scroll__WEBPACK_IMPORTED_MODULE_23__.headerScroll)();
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_intro_slider__WEBPACK_IMPORTED_MODULE_20__.initIntroSlider)();
    (0,_modules_init_hack_slider__WEBPACK_IMPORTED_MODULE_21__.initHackSlider)();
    (0,_modules_rev_popup__WEBPACK_IMPORTED_MODULE_22__.revPopup)();
    (0,_modules_head_mobile__WEBPACK_IMPORTED_MODULE_24__.headMobile)();
    (0,_modules_init_classes_without_slider__WEBPACK_IMPORTED_MODULE_25__.initClassesWithoutSlider)();
  });
});
}();
/******/ })()
