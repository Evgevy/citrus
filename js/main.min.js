...
var initGradeSlider = function initGradeSlider() {
  ...
  var checkResolution = function checkResolution() {
    var isMobile = window.innerWidth <= 1120;
...
var initHackSlider = function initHackSlider() {
  ...
  var swiper = new Swiper(slider, (_Swiper = {
    ...
    loop: true,
    resistance: true,
    // Добавляет "упругость" при перетаскивании
    resistanceRatio: 0.6,
    // Уровень сопротивления
    followFinger: false,
    // Отключает следование за пальцем (для плавности)
    touchReleaseOnEdges: true,
    // Позволяет "отпускать" слайды у краев
    initialSlide: 1,
    // Параметры для плавности
    easing: 'cubic-bezier(0.25, 0.1, 0.25, 1)'
  }, _defineProperty(_Swiper, "grabCursor", true), _defineProperty(_Swiper, "preloadImages", false), _defineProperty(_Swiper, "lazy", {
    loadPrevNext: true,
    loadPrevNextAmount: 2
  }), _defineProperty(_Swiper, "watchSlidesProgress", true), _defineProperty(_Swiper, "observer", true), _defineProperty(_Swiper, "observeParents", true), _defineProperty(_Swiper, "navigation", {
