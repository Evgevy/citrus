...
var initIntroSlider = function initIntroSlider() {
  ...
  var swiper = new Swiper(slider, {
    ...
    // Разрешает пролистывать до следующего/предыдущего слайда через край
    resistance: true,
    // Упрощает свайп на краях
    resistanceRatio: 0.7,
    // Позволяет немного потянуть за край

    //  Производительность
    watchSlidesProgress: false,
    //  Отключи, если не используешь progress
